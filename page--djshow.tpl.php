...
/**
 * @file
 * Default .tpl file for CT change from function: "CT Type Show"
 */
?>
...
<div id="main_container_logged"> 
  <header id="header_logged"><div class="section clearfix">
      <?php if ($logged_in): ?>
        <div id="<?php print $page[firstdiv_about] ?>" />
...
<?php if ($page['firstdiv_djshow']): ?>
      <div id="firstdiv_about" class="column"><div class="section">
        <?php print render($page['firstdiv_about']); ?>
      </div></div> 
    <?php endif; ?>
    
<?php if ($page['seconddiv_djshow']): ?>
      <div id="seconddiv_about" class="column"><div class="section">
        <?php print render($page['seconddiv_about']); ?>
      </div></div> 
    <?php endif; ?>
