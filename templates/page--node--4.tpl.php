...
<?php if ($page['slideshow_about']): ?>
      <div id="slideshow_about" class="column"><div class="section">
        <?php print render($page['slideshow_about']); ?>
      </div></div> 
    <?php endif; ?>
    
    <?php if ($page['firstdiv_about']): ?>
      <div id="firstdiv_about" class="column"><div class="section">
        <?php print render($page['firstdiv_about']); ?>
      </div></div> 
    <?php endif; ?>
    
<?php if ($page['seconddiv_about']): ?>
